    ...
    renderFrom() {
        return (
                ...
                <form action="#">
                    ...
                    <div className="mdl-cell--10-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    ...
                    <div className="mdl-cell--2-col mdl-js-textfield mdl-textfield--floating-label">
                    </div>
                    <div className="mdl-cell--2-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                    ...
                    <div className="mdl-cell--10-col mdl-textfield mdl-js-textfield">
