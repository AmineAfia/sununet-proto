            ...
            <label><h2>Subscription</h2></label>
                ...
                <form action="#">
                    ...
                    <div className="mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        ...
                        <label className="mdl-textfield__label" for="sample3">Nom...</label>
                    </div>
                    <div className="mdl-cell--12-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input className="mdl-textfield__input" type="text" id="sample3"/>
                        <label className="mdl-textfield__label" for="sample3">Prénom...</label>
                    </div>
                    ...
                    <div className="mdl-cell--4-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input className="mdl-textfield__input" type="text" id="sample3"/>
                        <label className="mdl-textfield__label" for="sample3">From ../../....</label>
                    </div>
                    <div className="mdl-cell--4-col mdl-textfield mdl-js-textfield mdl-textfield--floating-label">
                        <input className="mdl-textfield__input" type="text" id="sample3"/>
                        <label className="mdl-textfield__label" for="sample3">To ../../....</label>
                    </div>
                    ...
                    <div className="mdl-cell--12-col mdl-textfield mdl-js-textfield">
                        ...
                        <label className="mdl-textfield__label" for="sample5">Adresse...</label>
                    </div>
                    <div className="mdl-cell--12-col mdl-textfield mdl-js-textfield">
                        <textarea className="mdl-textfield__input" type="text" rows="3" id="sample5" ></textarea>
                        <label className="mdl-textfield__label" for="sample5">Commentaire...</label>
                    </div>
